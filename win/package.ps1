...
<Wix xmlns="http://schemas.microsoft.com/wix/2006/wi">
  <Product Id="*" Name="PowerShell 7 ARM64" Language="1033" Version="7.3.4.0" Manufacturer="Microsoft Corporation" UpgradeCode="31AB5147-9A97-4452-8443-D9709F0516E1">
    <Package InstallerVersion="200" Compressed="yes" InstallScope="perMachine" Platform="x64" Description="PowerShell 7.3.4 ARM64" Comments="PowerShell 7.3.4 ARM64" />
    <MediaTemplate EmbedCab="yes" />
    <Feature Id="ProductFeature" Title="setup" Level="1">
      <ComponentGroupRef Id="ProductComponents" />
    </Feature>
    <Upgrade Id="{31AB5147-9A97-4452-8443-D9709F0516E1}">
      <UpgradeVersion Maximum="7.3.4.0" Property="OLDPRODUCTFOUND" OnlyDetect="no" IncludeMinimum="yes" IncludeMaximum="no" />
    </Upgrade>
    ...
    <DirectoryRef Id="ApplicationProgramsFolder">
      <Component Id="ApplicationShortcut" Guid="{D4A0639B-7BDD-4912-9489-FB8D227D507C}">
        <Shortcut Id="ApplicationStartMenuShortcut"
                  ...
                  Description="PowerShell 7.3.4 for ARM64"
                  Target="[#pwsh.exe]"
